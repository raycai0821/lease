...
public class SystemUserController {
    ...
    public Result<IPage<SystemUserItemVo>> page(@RequestParam long current, @RequestParam long size, SystemUserQueryVo queryVo) {
        ...
        IPage<SystemUserItemVo> result = service.pageByQueryVo(page, queryVo);
    ...
    public Result<SystemUserItemVo> getById(@RequestParam Long id) {
        ...
        SystemUserItemVo adminVo = service.getSystemUserById(id);
    ...
    public Result<Boolean> isUsernameExists(@RequestParam String username) {
        ...
        lambdaUpdateWrapper.eq(SystemUser::getUsername, username);
        long count = service.count(lambdaUpdateWrapper);
